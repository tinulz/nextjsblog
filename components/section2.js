...
export default function section2() {
    ...
    // because data needs time to get data from fetcher('api/posts'), write retrun for isLoading and isError ...
    // otherwise, data.map will not running / error
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-14">
                {
                    data.map((value, index) => (
                        // call function post() as a component
